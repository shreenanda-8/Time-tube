...
function bsdk()
{
       ...
       xhr.open('GET',`https://youtube.googleapis.com/youtube/v3/commentThreads?part=snippet&maxResults=3000&videoId=${ID}&key=AIzaSyBsU5PwT17I-sl8KVcj1ddfKS5f6mI5INI`, true);
